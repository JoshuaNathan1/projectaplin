...
<div class="fake-navbar visible-lg scrolled">
</div>
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light visible-lg" id="ftco-navbar">
    <div style="width: 100%;padding: 15px;">
 	...
 	<div class="page-content">
 		<div class="container">
 			<div class="row visible-lg" style="height: 75px"></div>
 			<div class="row">
 				<div class="col-md-12 about-content">
					<div class="a-line1">
						<div class="a-inner-line1"></div>
					</div>
					<p class="a-p-logo">Project Aplin, Inc</p>
					<p>https://projectaplin</p>
					<p class="a-p-desc1">
						Pada tahun 2024, Tugas Aplin Di jalankan di semester 4
					</p>
					<p class="a-p-desc2">
						Dan Ini Hasilnya
					</p>
					<div class="a-line2"></div>
					<p class="a-p-region">Background Story</p>
					<p>https://projectaplin</p>
					<p class="a-p-desc3">
						Sebuah Project Aplin
					</p>
					<p class="a-p-desc4">
						Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, ipsam doloribus! Culpa, deleniti libero. Dolorem laudantium libero reprehenderit facere harum vero provident tempore. Totam quo officia ullam ducimus! Voluptatum, debitis.
                    </p>
 				</div>
 			</div>
 		</div>
 					...
 					<div class="col-md-7">
 						...
 						<p class="v-desc"></p>
                            <ul class="text-white pl-3">
                                <li>Menjadi Operator Waralaba Terbaik di Industri Real Estate Broker</li>
                                <li>Untuk menjadi Agensi Real Estate terdepan di Asia Pasifik dengan menyediakan solusi dan jasa yang evolusioner kepada Klien</li>
							</ul>
 						<p></p>
 					</div>
 					<div class="col-md-7">
 						...
 						<p class="m-desc"></p>
                            <ul class="text-white pl-3">
                                <li>Untuk Meningkatkan Profesionalisme Agen dan Profitabilitas masing-masing kantor dengan memberikan pelatihan potensial dan layanan terbaik</li>
                                <li>Untuk Menyediakan pengalaman transaksi yang Superior dengan penasihan terpercaya yang professional dan efisien.</li>
							</ul>
 						<p></p>
 					</div>
 				</div>
 			</div>
 			<div class="vm-image visible-lg"></div>
 		</div>
