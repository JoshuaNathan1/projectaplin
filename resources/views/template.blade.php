    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light visible-lg" id="ftco-navbar">
        <div style="width: 100%;padding: 15px;">
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav d-flex px-5 pt-2 justify-content-between">
                    <li class="nav-item text-white">
                        <a href="index.php" class="nav-link nav-submenu-parent">
                            <h4 class="text-white">&nbsp;PROJECT APLIN&nbsp;</h4>
                        </a>
                    </li>
                    {{-- <li style="width: 15%" class="nav-item "><a href="./about.php" class="nav-link"><span>&nbsp;Bergabung dengan Kami&nbsp;</span></a></li> --}}
                    ...
                    {{-- <li style="width: 10%" class="nav-item nav-submenu">
                        <a href="./office" class="nav-link"><span>&nbsp;Office &amp; Agents&nbsp;</span></a>
                        <div class="nav-submenu-content">
                    ...
                    <li class="nav-item" style="width: 50px">
                        <div style="display:flex;flex-direction:row;line-height:0.8">
                            <a title="Bahasa" href="./login" class="itl-tooltip text-white p-3 border rounded" data-placement="top">
                                Login
                            </a>
                        </div>
